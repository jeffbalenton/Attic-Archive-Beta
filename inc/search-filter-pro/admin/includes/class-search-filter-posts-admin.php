...
class Search_Filter_Posts_Admin {
	...
	{
		wp_enqueue_script( $this->plugin_slug . '-admin-posts-script', my_plugins_url( 'admin/assets/js/admin-posts.js','search-filter-pro/search-filter-pro.php'), array( 'jquery-ui-sortable', 'jquery-ui-draggable', 'jquery' ), Search_Filter_Admin::VERSION );
	}
