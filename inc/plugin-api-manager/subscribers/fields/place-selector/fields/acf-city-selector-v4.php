        ...
        class acf_field_city_selector extends acf_field {
            ...
            */
            ...
            function create_options( $field ) {
                ...
                <tr class="field_option field_option_<?php echo $this->name; ?>">
                    <td class="label">
                        <label><?php esc_html_e("Show labels",'acf-place-selector'); ?></label>
                        <p class="description"><?php esc_html_e( 'Show field labels above the dropdown menus', 'acf-place-selector' ); ?></p>
                    </td>
                    <td>
                        <?php
            ...
            function create_field( $field ) {
                ...
                <div class="dropdown-box cs-countries">
                    <?php if ( $field['show_labels'] == 1 ) { ?>
                        <span class="acf-input-header"><?php esc_html_e( 'Select country', 'acf-place-selector' ); ?></span>
                    <?php } ?>
                ...
                <div class="dropdown-box cs-provinces">
                    <?php if ( $field['show_labels'] == 1 ) { ?>
                        <span class="acf-input-header"><?php esc_html_e( 'Select province/state', 'acf-place-selector' ); ?></span>
                    <?php } ?>
                ...
                <div class="dropdown-box cs-places">
                    <?php if ( $field['show_labels'] == 1 ) { ?>
                        <span class="acf-input-header"><?php esc_html_e( 'Select city', 'acf-place-selector' ); ?></span>
                    <?php } ?>
            ...
            */
            ...
            function input_admin_enqueue_scripts() {
                ...
                wp_register_script( 'acf-input-place-selector', "{$url}assets/js/place-selector.js", '', $version );
                wp_enqueue_script( 'acf-input-place-selector' );
            ...
            */
            function input_admin_head() {
                ...
                wp_enqueue_script( 'acf-custom-validation', "{$url}assets/js/field-validation.js", array( 'acf-input' ), $version );
                wp_enqueue_script( 'acf-custom-validation' );
                wp_register_script( 'acf-place-selector-js', "{$url}assets/js/place-selector.js", '', $version );
                wp_enqueue_script( 'acf-place-selector-js' );
                ...
                if ( isset( $_GET[ 'action' ] ) && $_GET[ 'action' ] === 'edit' ) {
                    ...
                    $field_name = 'ACF_Place_Selector';
                    if ( is_array( $fields ) && count( $fields ) > 0 ) {
                        foreach( $fields as $field ) {
                            if ( isset( $field[ 'type' ] ) && $field[ 'type' ] == 'ACF_Place_Selector' ) {
                    ...
                    if ( ! empty( $post_meta[ 'cityName' ] ) ) {
                        wp_localize_script( 'acf-place-selector-js', 'city_selector_vars', array(
