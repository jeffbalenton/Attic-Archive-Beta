...
class ACF_Child_Post_Field_V5 extends acf_field {
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script( 'acf-input-acf-child-post-field', get_template_directory_uri() . '/inc/plugin-api-manager/subscribers/fields/acf-child-post-field/assets/js/acf-child-post-field.js');
		wp_enqueue_script( 'acf-input-acf-child-post-field' );


		// register & include CSS
		wp_register_style( 'acf-input-acf-child-post-field', get_template_directory_uri() . '/inc/plugin-api-manager/subscribers/fields/acf-child-post-field/assets/css/acf-child-post-field.css');
