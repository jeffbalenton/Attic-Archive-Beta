<?php
	...
	$labels = [
        'name'                  => _x( 'Developer', 'Post type general name', 'recipe' ),
        'singular_name'         => _x( 'Developer', 'Post type singular name', 'recipe' ),
        'menu_name'             => _x( 'Developers', 'Admin Menu text', 'recipe' ),
        'name_admin_bar'        => _x( 'Developer', 'Add New on Toolbar', 'recipe' ),
        'add_new'               => __( 'Add Developer', 'recipe' ),
        'add_new_item'          => __( 'Create Developer', 'recipe' ),
        'new_item'              => __( 'New Developer', 'recipe' ),
        'edit_item'             => __( 'Edit Developer', 'recipe' ),
        'view_item'             => __( 'View Developer', 'recipe' ),
        'all_items'             => __( 'Developers', 'recipe' ),
        'search_items'          => __( 'Search Developers', 'recipe' ),
        'parent_item_colon'     => __( 'Parent Developer:', 'recipe' ),
        'not_found'             => __( 'No Developers found.', 'recipe' ),
        'not_found_in_trash'    => __( 'No Developers found in Trash.', 'recipe' ),
        'featured_image'        => _x( 'Developer Profile Image', 'Overrides the “Featured Image” phrase for this post type. Added in 4.3', 'recipe' ),
        ...
        'archives'              => _x( 'Developers archive', 'The post type archive label used in nav menus. Default “Post Archives”. Added in 4.4', 'recipe' ),
	...
	$args = [
		"label" => __( "Developers", "hello-elementor" ),
		"labels" => $labels,
		"description" => "",
		"public" => true,
		...
		"map_meta_cap" => true,
		"hierarchical" => false,
		"rewrite" => [ "slug" => "Developer", "with_front" => true ],
		"query_var" => true,
