...
class Search_Filter_Admin {
	...
	public function enqueue_admin_styles() {
		...
		if ( in_array ( $screen->id, $this->plugin_screen_hook_suffix ) ) {
			...
			wp_enqueue_style( $this->plugin_slug .'-admin-styles', my_plugins_url( 'admin/assets/css/admin.css', 'search-filter-pro/search-filter-pro.php' ), array(), Search_Filter_Admin::VERSION );
	...
	public function enqueue_admin_scripts() {
		...
		$screen = get_current_screen();
		if ( in_array ( $screen->id, $this->plugin_screen_hook_suffix ) ) {
			wp_enqueue_script( $this->plugin_slug . '-admin-script', my_plugins_url( 'admin/assets/js/admin.js', 'search-filter-pro/search-filter-pro.php' ), array( 'jquery' ), Search_Filter_Admin::VERSION );
		}
