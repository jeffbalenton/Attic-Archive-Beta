...
class Search_Filter {
	...
	public function enqueue_styles()
	{
		...
		if($load_js_css === 1)
		{
			wp_enqueue_style( $this->plugin_slug . '-plugin-styles', my_plugins_url( 'public/assets/css/search-filter'.$file_ext, 'search-filter-pro/search-filter-pro.php' ), array(), self::VERSION );
		}
	}
	...
	public function register_scripts() {
		...
		wp_register_script( $this->plugin_slug . '-plugin-build', my_plugins_url( 'public/assets/js/search-filter-build'.$file_ext, 'search-filter-pro/search-filter-pro' ), array('jquery'), self::VERSION );
		wp_register_script( $this->plugin_slug . '-plugin-chosen', my_plugins_url( 'public/assets/js/chosen.jquery'.$file_ext, 'search-filter-pro/search-filter-pro' ), array('jquery'), self::VERSION );
		wp_register_script( $this->plugin_slug . '-plugin-select2', my_plugins_url( 'public/assets/js/select2'.$file_ext, 'search-filter-pro/search-filter-pro' ), array('jquery'), self::VERSION);
