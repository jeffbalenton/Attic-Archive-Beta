   ...
   * * * * * * * * * */ 
    ...
    function do_import() {
      ...
      $import_check = get_option( 'import_status' );
		...
		$attachment_id = media_handle_upload($this->xmlfile,0);
      ...
      $this->import ( $file );
        ...
        update_option( 'import_status', 'yes' );
      endif;
    ...
    function import_start( $file ) {
      ...
      $this->posts = $import_data[ 'posts' ];
       update_option('imported_posts',$this->posts);
		update_option('imported_file',$this->xmlfile);
