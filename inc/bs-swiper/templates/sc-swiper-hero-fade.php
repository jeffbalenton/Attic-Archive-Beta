...
add_shortcode( 'bs-swiper-hero-fade', 'archive_swiper_hero_fade' );
function archive_swiper_hero_fade( $atts ) {
	ob_start();
            ...
            <div class="position-absolute top-0 end-0 bottom-0 start-0">
                ...
                <div class="container h-100 d-flex flex-column">
                    ...
                    <div class="mt-auto text-white mb-5 text-center">
                        ...
                        <a class="read-more btn btn-light" href="<?php the_permalink(); ?>"><?php _e('Read more »', 'archive'); ?></a>
