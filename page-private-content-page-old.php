...
<div class="container">
  <div class="row">
    <div class="col-sm-6">
      <p class='display-6 text-center'>Restricted Content</p>
...
<form class="admin-email-confirm-form" name="admin-email-confirm-form" action="<?php echo esc_url( site_url( 'wp-login.php?action=confirm_admin_email', 'login_post' ) ); ?>" method="post">
  ...
  <div class="admin-email__actions">
    <div class="admin-email__actions-primary">
      ...
      ?>
      <a class="button button-large" href="<?php echo esc_url( $change_link ); ?>">
      <?php _e( 'Update' ); ?>
      </a>
    ...
    <div class="admin-email__actions-secondary">
      ...
      ?>
      <a href="<?php echo esc_url( $remind_me_link ); ?>">
      <?php _e( 'Remind me later' ); ?>
      </a></div>
    <?php endif; ?>
  </div>
</form>
...
<p id="nav"><a href="<?php echo esc_url( wp_login_url() ); ?>">
  <?php _e( 'Log in' ); ?>
  </a>
  <?php
...
<form name="resetpassform" id="resetpassform" action="<?php echo esc_url( network_site_url( 'wp-login.php?action=resetpass', 'login_post' ) ); ?>" method="post" autocomplete="off">
  ...
  <p class="submit reset-pass-submit">
    <button type="button" class="button wp-generate-pw hide-if-no-js skip-aria-expanded">
...
case 'register':
  ...
  login_header( __( 'Registration Form' ), '<p class="message register border border-warning border-top-0 border-start-0 border-end-0 display-4">' . __( 'Register Now' ) . '</p>', $errors );

  ?>
<form name="registerform" id="registerform" action="<?php echo home_url('/private-content-page?action=register'); ?>" method="post" novalidate="novalidate" class="border border-warning p-2 container">
  <div class="row">
    <div class="col mb-3">
  ...
  <div class="row">
    <div class="col">
      <input type="text" name="user_login" id="user_login" class="input" value="<?php echo esc_attr( wp_unslash( $user_login ) ); ?>" size="20" autocapitalize="off" autocomplete="username" placeholder="Username"/>
    </div>
    <div class='col'>
      <input type="email" name="user_email" id="user_email" class="input" value="<?php echo esc_attr( wp_unslash( $user_email ) ); ?>" size="25" autocomplete="email" placeholder="Email Address"/>
    </div>
  </div>
  <div class="row">
	  <div class="col">
	...
	<div class='form-check'>
     <input type="checkbox" id="myCheck" class='form-check-input' onclick="myFunction()" >
	<label class"form-check-label">I want to contribute to the archive</label>
	 </div>
	  </div>
	</div>
	<div id="contribute" style="display: none" class="row">
	  <div class="col-sm-6">
    <input type="text" class="form-control" placeholder="Referring User First Nam" aria-label="First name" name="r_fname" >
  </div>
  <div class="col-sm-6">
    <input type="text" class="form-control" placeholder="Referring User Last name" aria-label="Last name" name="r_lname" >
  </div>
  </div>
	<input type="hidden" name="redirect_to" value="<?php echo esc_attr( $redirect_to ); ?>" class='form-control'/>
...
<p id="nav"><a href="<?php echo esc_url( wp_login_url() ); ?>">
  ...
  </a><?php echo esc_html( $login_link_separator ); ?><a href="<?php echo esc_url( wp_lostpassword_url() ); ?>">
