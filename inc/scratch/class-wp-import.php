...
class WP_Import extends WP_Importer {
	...
	function dispatch() {
		...
		$file = get_template_directory() . '/inc/autoimport/import.xml'; //file to import
		...
		$user = get_user_by( 'display_name', 'Webmaster' ); //Mapped User Logic
  ...
  $user_id=wp_insert_user( $userdata );	 
		$this->mapped_user_id=$user_id;
		endif;
		$this->mapped_user_id=$user->ID;
...
*/
	...
	function import( $file ) {
		...
		$this->get_author_mapping($this->mapped_user_id);
...
<?php
	 ...
	 */
	function get_author_mapping($map_user_id) {
