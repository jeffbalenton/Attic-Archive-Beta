...
<div id="content" class="site-content container py-5 mt-4">
  ...
  <div class="row">
    <div id="content-area" class="col-sm-9 border-secondary">
      ...
      <?php foreach ( $album_photo as $post_ids ) : ?>
			<div class="col">
				<div class="d-flex flex-column align-items-center">
					<div class="p-2">
					<?php echo get_the_post_thumbnail($post_ids, 'medium') ?>
					</div>
					<div class="p-2">
      <a href="<?php echo get_permalink( $post_ids ); ?>" class="link-warning nav-link">More Info</a>
					</div>
				</div>
			</div>
      <?php endforeach; ?>
