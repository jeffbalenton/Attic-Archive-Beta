    ...
    if ( ! class_exists( 'ACF_City_Selector' ) ) {
        ...
        class ACF_City_Selector {
            ...
            public function __construct() {
                ...
                $this->settings = array(
                    'db_version' => '1.0',
                    'url'        => my_plugins_dir_url( 'acf/custom/fields/city-selector/plugin.php' ),
                    'version'    => '1.3.2',
                );
                ...
                if ( ! defined( 'ACFCS_PLUGIN_PATH' ) ) {
                    $plugin_path = get_template_directory() .'/inc/acf/custom/fields/city-selector';
						
                    define( 'ACFCS_PLUGIN_PATH', $plugin_path );
                }

                if ( ! defined( 'ACFCS_PLUGIN_URL' ) ) {
                    $plugin_url = get_template_directory_uri() .'/inc/acf/custom/fields/city-selector';
              ...
              //  add_filter( 'plugin_action_links_' . plugin_basename( __FILE__ ), array( $this, 'acfcs_settings_link' ) );
                ...
                require 'inc/acfcs-actions.php';
                require 'inc/acfcs-functions.php';
                require 'inc/acfcs-help-tabs.php';
                require 'inc/acfcs-i18n.php';
               require 'inc/acfcs-ajax.php';
            ...
            public function acfcs_check_table() {
                ...
                if ( false == $acfcs_db_version || $acfcs_db_version != $this->settings[ 'db_version' ] ) {
				 ...
				 if ( false == get_option( 'acfcs_preserve_settings' ) ) {
                    $this->acfcs_fill_database();
					 update_option('acfcs_preserve_settings', true);
                }
            }
            ...
            public static function acfcs_admin_menu() {
                ...
                $menu = '<p class="acfcs-admin-menu">' . $dashboard . $search . $preview . $settings . $info  . '</p>';
            ...
            public function acfcs_add_scripts() {
                wp_enqueue_style( 'acfcs-general', my_plugins_url( 'assets/css/general.css', 'acf/custom/fields/city-selector/plugin.php' ), [], $this->settings[ 'version' ] );
                if ( is_admin() ) {
                    wp_enqueue_style( 'acfcs-admin', my_plugins_url( 'assets/css/admin.css', 'acf/custom/fields/city-selector/plugin.php' ), [], $this->settings[ 'version' ] );
                    wp_register_script( 'acfcs-admin', my_plugins_url( 'assets/js/upload-csv.js', 'acf/custom/fields/city-selector/plugin.php' ), [ 'jquery' ], $this->settings[ 'version' ] );
