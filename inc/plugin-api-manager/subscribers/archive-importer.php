 ...
 */
class Archive_Import extends WP_Importer {
	...
	function import() {
		...
		$import_check=get_option('import_status');
		if($import_check !== 'completed'):
...
$importer= new Archive_Import();
$importer->import();
}
add_action('admin_init','archive_importer_init');

/*function wp_importer_init() {
	load_plugin_textdomain( 'wordpress-importer' );

	
	$GLOBALS['wp_import'] = new Archive_Import();
	register_importer( 'wordpress', 'WordPress', __('Import <strong>posts, pages, comments, custom fields, categories, and tags</strong> from a WordPress export file.', 'wordpress-importer'), array( $GLOBALS['wp_import'], 'dispatch' ) );
}*/
//add_action( 'admin_init', 'wp_importer_init' );